...
const Header = () => {
  ...
  return (
    <header className="flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5 bg-white shadow-md">
      <Link href='/'>
        <Image 
          src="https://links.papareact.com/208"
          alt='FakeStoreAPI logo'
          width={150}
          height={150}
        ...
        <form action={formData => {
          ...
          <div className="flex items-center gap-2 w-full px-4">
            <div className="flex items-center space-x-2 bg-white shadow-xl rounded-full border-0 px-6 py-4 md:max-w-5xl flex-1">
              ...
              <input type="text" name="searchTerm" placeholder="Search..." className="outline-none flex-1 text-gray-700 placeholder-gray-400" />
            </div>
      ...
      <div className="hidden lg:flex flex-1 justify-end">
        <Avatar name="User" round size="50" className="shadow-md" />
      </div>
    </header>
  );
}
